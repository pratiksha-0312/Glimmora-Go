...
perm = [
    ("Dashboard",         "W", "—", "—", "Stats + recent rides"),
    ("Rides",             "W", "—", "—", "Cancel/complete/reassign/share"),
    ("SOS Alerts",        "R", "—", "—", "Live sidebar badge"),
    ("Drivers list",      "W", "—", "—", ""),
    ("Driver docs",       "W", "—", "—", "Per-document approve/reject + note"),
    ("Riders",            "R", "—", "—", "Search + lifetime spend"),
    ("Fares",             "W", "—", "—", "Per-city fare config"),
    ("Concessions",       "W", "—", "—", "Women/senior/children multipliers"),
    ("Coupons",           "W", "—", "—", "Flat/%, usage limit, expiry"),
    ("Cities",            "W", "—", "—", "Includes archetype defaults editor"),
