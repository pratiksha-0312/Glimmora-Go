...
const TABS = [
  { href: "/k", label: "Home", icon: Home, exact: true },
  { href: "/k/book", label: "Book", icon: Plus },
  { href: "/k/bookings", label: "History", icon: List },
  { href: "/k/profile", label: "Profile", icon: User },
];

export function KiranaNav() {
