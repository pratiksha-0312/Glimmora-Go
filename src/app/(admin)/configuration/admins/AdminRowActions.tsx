    ...
    <>
      <div className="flex justify-end gap-2 text-xs">
        <button
          ...
          disabled={busy}
          className="inline-flex items-center gap-1 rounded-md border border-slate-200 bg-white px-2 py-1 font-medium text-slate-700 transition hover:bg-[color:var(--brand-cream)] disabled:opacity-50"
        >
